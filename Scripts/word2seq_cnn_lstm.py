...
from keras.layers import LSTM, Conv1D, MaxPool1D
...
model = Sequential(name="Word2Seq_CNN_LSTM")

model.add(Embedding(input_dim=WORDS_SIZE, output_dim=250, input_length=INPUT_SIZE))
...
mld = "Models/word2seq_cnn_lstm.hdf5"
