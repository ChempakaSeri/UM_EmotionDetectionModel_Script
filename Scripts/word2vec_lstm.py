...
mydata = pd.read_json('/Users/chempakaseri/Spyder/emotion/Data/anger.json')
mydata1 = pd.read_json('/Users/chempakaseri/Spyder/emotion/Data/fear.json')
mydata = mydata.append(mydata1)
mydata = shuffle(mydata)

mydata1 = pd.read_json('/Users/chempakaseri/Spyder/emotion/Data/joy.json')
mydata = mydata.append(mydata1)
mydata = shuffle(mydata)

mydata1 = pd.read_json('/Users/chempakaseri/Spyder/emotion/Data/love.json')
mydata = mydata.append(mydata1)
mydata = shuffle(mydata)

mydata1 = pd.read_json('/Users/chempakaseri/Spyder/emotion/Data/sadness.json')
mydata = mydata.append(mydata1)
mydata = shuffle(mydata)

mydata1 = pd.read_json('/Users/chempakaseri/Spyder/emotion/Data/surprise.json')
mydata = mydata.append(mydata1)
mydata = shuffle(mydata)
...
word2vec = KeyedVectors.load_word2vec_format('/Users/chempakaseri/Spyder/emotionmodel/GoogleNews-vectors-negative300.bin', binary=True)
word2vec_2 = KeyedVectors.load_word2vec_format('/Users/chempakaseri/Spyder/emotionmodel/word2vec-combined-256.npy', binary = True)
...
callbackdir= '/Users/chempakaseri/Spyder/emotionmodel/ten'
...
mld = '/Users/chempakaseri/Spyder/emotionmodel/Models/word2vec_lstm.hdf5'
